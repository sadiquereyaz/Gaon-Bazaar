...
import com.reyaz.gaonbazar.components.EachOrderItem
import com.reyaz.gaonbazar.components.TabContent
...
//        }
        ...
        Card(
            ...
            Column(
                ...
                EachOrderItem("item Name", 125)
                EachOrderItem()
                EachOrderItem()
//                val totalPrice = calTotalPrice()
//                val deliveryCharge = calDeliveryCharge()
                EachOrderItem(name = "Delivery Charge", 10)

                Spacer(modifier = Modifier.height(4.dp))
                EachOrderItem("Grand Total", 500, fontWeight = FontWeight.Bold)
